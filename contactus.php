  ...
  <body>
	...
	<div class="container-fluid">
	  <div class="container">
	    ...
	    <br>
	    <br>
	    <form action="" name="bookform" method="post">
	      <center>
	        <fieldset style="height:auto;  width: 50%; align-content: center; border: solid; border-color: #00CA8E">
	          <h3>Admin Panel - Group 54&nbsp;</h3>
	          <br>
	          <table width="50%" height="auto" border="1">
	            ...
	            <tr align="center">
	              <td>Pasindu Piyumika</td>
	              <td>29091</td>
                </tr>
	            <tr align="center">
	              <td>Shehana Tharuka</td>
	              <td>28548</td>
                </tr>
	            <tr align="center">
	              <td>Nethmini Sanjana</td>
	              <td>28305</td>
                </tr>
	            <tr align="center">
	              <td>Pavani Nisansala</td>
	              <td>28929</td>
                </tr>
	            <tr align="center">
	              <td>Dasuni Ruwanthika</td>
	              <td>28485</td>
                </tr>
	            <tr align="center">
	              <td>Dasuni Nawarathna</td>
	              <td>29021</td>
                </tr>
	            <tr align="center">
	              <td>Ayesh Dharmasena</td>
	              <td>28907</td>
                </tr>
	            <tr align="center">
	              <td>Hansaka Warnasuriya</td>
	              <td>28788</td>
                </tr>
	            <tr align="center">
	              <td>Malshika Dhananjaya</td>
	              <td>28836</td>
                </tr>
				<tr align="center">
	              <td>Akash Chathumal</td>
	              <td>28787</td>
                </tr>
              </table>
            </fieldset>
